...
const config: ClientConfig = {
  ...
  domain: { primary: "demo-minimalist.mixturemarketing.pl", canonicalScheme: "https" },
  ...
  sections: [
    {
      ...
      enabled: true,
      config: {
        heading: "Uprawnienia i gwarancje",
        items: [
          { label: "Wpis na listę adwokatów", value: "Okręgowa Rada Adwokacka we Wrocławiu, nr 1872", type: "license" },
          { label: "Polisa OC zawodowa", value: "10 mln zł — PZU SA, nr polisy 824/2026", type: "insurance" },
          { label: "Członkostwo", value: "Naczelna Rada Adwokacka · Stowarzyszenie Prawników Rynku Kapitałowego", type: "chamber" },
          { label: "Certyfikat", value: "Mediator stały przy Sądzie Okręgowym we Wrocławiu", type: "certificate" },
        ],
      },
    },
    { kind: "pricing", enabled: true },
    {
      ...
      enabled: true,
      config: {
        heading: "Nasi prawnicy",
        members: [
          { name: "adw. Krzysztof Wiśniewski", role: "Partner zarządzający", bio: "Specjalista prawa gospodarczego z 18-letnim doświadczeniem. Reprezentował klientów przed Sądem Najwyższym." },
          { name: "adw. Maria Kowalska", role: "Adwokat", bio: "Prawo pracy i rodzinne. Mediator w sprawach cywilnych." },
          { name: "r.pr. Tomasz Lewandowski", role: "Radca prawny", bio: "Doradztwo podatkowe i prawne dla firm. Były ekspert MF." },
        ],
      },
    },
    {
      ...
      enabled: true,
      config: {
        heading: "Publikacje i wystąpienia",
        items: [
          { date: "2026-03", title: "Nowy ład w prawie spadkowym — co zmienia rok 2026?", source: "Rzeczpospolita", type: "article", url: "https://www.rp.pl" },
          { date: "2025-11", title: "Mediacja w sporach gospodarczych — wystąpienie konferencyjne", source: "VII Kongres Prawa Gospodarczego, Warszawa", type: "speech" },
          { date: "2025-09", title: "Prawo upadłościowe dla mikrofirm — wywiad", source: "Forbes Polska", type: "interview", url: "https://www.forbes.pl" },
          { date: "2024-06", title: "Prawo handlowe w praktyce", source: "Wydawnictwo C.H. Beck, wydanie III rozszerzone", type: "book" },
          { date: "2024-02", title: "Klauzule abuzywne w umowach B2B", source: "Dziennik Gazeta Prawna", type: "article" },
        ],
      },
    },
    {
      ...
      config: {
        ...
        url: "https://cal.com/wisniewski/konsultacja-30min",
        durationMinutes: 30,
        price: "200 zł brutto",
        note: "Pierwsza 15-minutowa rozmowa wstępna jest bezpłatna — wybierz \"Rozmowa wstępna\" w kalendarzu.",
      },
    },
  ],
};
