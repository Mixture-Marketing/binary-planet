...
│   ├── admin/            ← mm-admin — ✅ Track J2 + J3 + J4 + Track 1 + Track 4 (admin + onboarding wizard + provisioning dry-run, 41 tests)
│   ├── panel/            ← mm-panel — ✅ Track 2 v0.1 (Astro 5 klient panel + magic link + 7 pages, shared D1, 21 tests)
